    ...
    return(
        <>
            ...
            {addedPhotos.length > 0 && addedPhotos.map(link => (
               <div className="h-32 flex w-full object-cover relative" key={link}>
               <img className="rounded-2xl" src={'http://localhost:4000/'+link} alt=""/>
               <button onClick={(ev) =>removePhoto(ev,link)}  className="absolute bottom-1 right-2 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3">
